package com.rominaesba.polimorfismok.r.Controllers;

import com.rominaesba.polimorfismok.r.Models.SQLdata;
import com.rominaesba.polimorfismok.r.Models.Oracledata;
import com.rominaesba.polimorfismok.r.Models.dBasedata;

import com.rominaesba.polimorfismok.r.Models.ICRUD;
import com.rominaesba.polimorfismok.r.Models.Estudiante;
...
public class helloController {
   ...
   private TableColumn<Estudiante, Integer> MatriculaColumna;
    ...
    void OnActionAgregarButton(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/rominaesba/polimorfismok/r/guardar-view.fxml"));
    ...
    void OnActionActualizarButton(ActionEvent event) {
        ...
        if (seleccionar == null){
            ...
            try {
                FXMLLoader loader = new FXMLLoader(this.getClass().getResource("/com/rominaesba/polimorfismok/r/guardar-view.fxml"));
